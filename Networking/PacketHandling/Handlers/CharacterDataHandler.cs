...
using static MUnique.OpenMU.Network.Packets.ServerToClient.SkillListUpdate; // For PacketHandlerAttribute
...
namespace MuOnlineConsole.Networking.PacketHandling.Handlers
{
    ...
    public class CharacterDataHandler : IGamePacketHandler
    {
        ...
        private readonly SimpleLoginClient _client; // Needed for UpdateConsoleTitle
        private readonly TargetProtocolVersion _targetVersion;

        public CharacterDataHandler(ILoggerFactory loggerFactory, CharacterState characterState, SimpleLoginClient client, TargetProtocolVersion targetVersion)
        {
